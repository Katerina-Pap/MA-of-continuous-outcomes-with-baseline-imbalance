...
class study arm;
model y2= y1center study y1center*study group/s CL ddfm=satterthwaite;
...
proc mixed data=ipd method = reml;
class study groupc;
model y2= y1center study study*y1center group/s cl ddfm=satterthwaite;
random groupcenter/subject=study type=un s;
...
class study;
model estimate= /  solution cl ddfm=satterthwaite;
